...
class UserDataSourceNew(val apiService: ApiService, val page:String) : PagingSource<Int, NewImageModelItem>() {
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, NewImageModelItem> {
        try {
            ...
            val imageData = apiService.getNewImages(client_id, nextPageNumber.toString())
